...
- ex)
  - Bottom Navigation 영역(하단 탭)을 유저가 원하는 순서로 커스텀할 수 있게 합니다.
...
- ex)
  - 다양한 탭을 사용하는 유저는 Segment에 따라 하단 탭의 노출 수와 사용 빈도가 다릅니다.
  - 예를 들어, 20대와 30대의 추천 탭 노출 수 사이는 월 n만 정도입니다.
...
- ex)
  - o Bottom Navigation의 순서를 유저가 편집할 수 있게 한다.
...
- ex)
  - o 사용하지 않는 탭의 삭제 기능 등 ‘순서 편집’ 외 하단 탭에 관련한 추가적인 기능 개발
  - o 순서 정렬 및 저장 API 개발
